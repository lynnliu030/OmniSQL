# just the eval parts from auto_evaluation.py
...
if __name__ == "__main__":
    ...
    # greedy decoding
    gs_pred_file = f"results/{opt.eval_name}/greedy_search.json"
    ...
    if opt.source in ["bird", "spider2.0"]:
        ...
        pass_at_k_acc_dict[""] = pass_at_k_acc
    ...
    major_voting_acc_dict[""] = major_voting_acc
