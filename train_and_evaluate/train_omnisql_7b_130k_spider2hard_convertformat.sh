...
CKPT_NUM=10
BASE_NAME="FORMAT_qwencoder_7b_instruct_lr${LR}_epochs${EPOCHS}_filter_domain_spider2_non_simple_moderate_130651"
...
DATASET_DIR="./data/train_synsql_filter_in_domain_spider2_non_simple_moderate_130651_RL_FORMAT.json"
