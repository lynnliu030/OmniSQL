...
CKPT_NUM=10
BASE_NAME="qwencoder_7b_instruct_lr${LR}_epochs${EPOCHS}_filter_domain_spider2_non_simple_moderate_downsample_13k"
CKPT_DIR="./ckpts/$BASE_NAME"
LOG_DIR="./train_logs/$BASE_NAME"
# DATASET_DIR="./data/train_bird.json"
# DATASET_DIR="./data/train_spider.json"
DATASET_DIR="./data/train_synsql_filter_in_domain_spider2_non_simple_moderate_downsample_13k.json"
